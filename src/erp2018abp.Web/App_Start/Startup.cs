...
﻿using Abp.Owin;
using erp2018abp.Api.Controllers;
using erp2018abp.Web;
...
namespace erp2018abp.Web
{
    public class Startup
    {
        public void Configuration(IAppBuilder app)
        {
            ...
            //ENABLE TO USE HANGFIRE dashboard (Requires enabling Hangfire in erp2018abpWebModule)
